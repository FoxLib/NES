    ...
    for (i = 0; i < scale; i++) {
        ...
        for (j = 0; j < scale; j++) {
            ...
            if (TX >= 0 && TX < WIDTH && TY >= 0 && TY < HEIGHT) {
                ...
                int _r =  color & 0xff;
                int _g = (color >> 8) & 0xff;
                int _b = (color >> 16) & 0xff;

                if (i == 1 && (TX < 512) && (TY > (HEIGHT - 480))) {
                ...
                frame[ HEIGHT - 1 - y - i ][ x + j ].b = _r;
                frame[ HEIGHT - 1 - y - i ][ x + j ].g = _g;
                frame[ HEIGHT - 1 - y - i ][ x + j ].r = _b;
            }
        }
    }
...
void printRegisters() {
    ...
    printString(1,  baseline + 21, "F12 Sav         F9 One        ", 0x808080, 0);
    ...
    printString(1,  baseline + 21, "F12", 0xC0A000, 0);
